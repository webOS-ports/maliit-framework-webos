...
public:
    ...
    /*!
     * \brief returns enter key type for focused widget if output parameter valid is true,
     * value matches enum M::enterKeyType
     */
     ...
     * \brief get surrounding text and cursor position information
     */
    virtual bool maxTextLength(int &maxTextLength) = 0;

     /*!
     * \brief get placeholer text
     */
    virtual bool platformData(QString &pattern) = 0;
